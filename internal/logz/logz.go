...
func WorkspaceID(id string) zap.Field {
	return zap.String("workspace_id", id)
}
...
func WatchedNamespace(namespace string) zap.Field {
	return zap.String("watched_namespace", namespace)
}
